...
type MeshclientApiService service

/*
MeshclientApiService Retrieve a file from the file server.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param filename Filename

@return *os.File
*/
func (a *MeshclientApiService) GetFile(ctx context.Context, filename string) (*os.File, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/meshclient/files/{filename}"
