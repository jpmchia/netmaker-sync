...
/*
UsersApiService Lists all the users attached to an ingress gateway.
...
@return LegacyNode
*/
func (a *UsersApiService) IngressGatewayUsers(ctx context.Context, network string, nodeid string) (LegacyNode, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/nodes/{network}/{nodeid}/ingress/users"
