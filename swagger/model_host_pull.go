...
type HostPull struct {
	ChangeDefaultGw bool `json:"change_default_gw,omitempty"`
	DefaultGwIp string `json:"default_gw_ip,omitempty"`
	EgressNetworkRoutes []EgressNetworkRoutes `json:"egress_network_routes,omitempty"`
	EndpointDetection bool `json:"endpoint_detection,omitempty"`
	FwUpdate *FwUpdate `json:"fw_update,omitempty"`
	Host *Host `json:"host,omitempty"`
	HostNetworkInfo *HostInfoMap `json:"host_network_info,omitempty"`
	IsInetGw bool `json:"is_inet_gw,omitempty"`
	Nodes []Node `json:"nodes,omitempty"`
	PeerIds *PeerMap `json:"peer_ids,omitempty"`
